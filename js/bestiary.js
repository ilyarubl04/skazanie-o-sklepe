(function (root) {
  ...
  var ENEMIES = {
    ...
    // --- Акт 5 (Сердце Бездны) — ФИНАЛЬНЫЙ БОСС ---
    // Трёхфазный: Пастырь Тишины (человек-архижрец, призыв послушников) →
    // Проводник (тёмная волна-AoE + призыв призраков) → Безмолвная Мать (ярость).
    // Камертоны и Светоч снижают его эффективный стартовый HP (см. main.js).
    shepherd: {
      id: 'shepherd', name: 'Пастырь Тишины', art: 'assets/enemies/shepherd.png',
      maxHp: 90, defense: 15, attack: { bonus: 5, damage: 'd8+2' },
      boss: true, undead: false,
      special: {
        summon: 'cultist', summonEvery: 2,
        phases: [
          { at: 0.66, wave: 'd8', summon: 'wraith', summonEvery: 3 },
          { at: 0.33, enrage: true, wave: 'd8', waveEvery: 2 }
        ]
      },
      desc: 'Архижрец павшего Ордена, ставший проводником Безмолвной Матери из Бездны. Ф1: ведёт послушников. Ф2 (<66%): обрушивает тёмную волну и поднимает призраков. Ф3 (<33%): впадает в неистовство. Камертоны и Светоч ослабляют его.'
    }
  };
